 ...
 */
FARPROC WINAPI ResultDisplayDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = ResultDisplayDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = ResultDisplayDelayLoadWin32FailureHook;
#endif
