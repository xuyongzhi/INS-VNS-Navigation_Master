...
hold on
plot(dQTb_position(1,:),dQTb_position(2,:),'g-.','lineWidth',lineWidth);
hold on
plot(newdQTb_position(1,:),newdQTb_position(2,:),'r:','lineWidth',lineWidth);
% plot(SINS_position(1,1),SINS_position(2,1),'o')

lh=legend('真实','视觉','传统组合','新组合');
...
% set(gcf,'position',figurePosition) ;
% subplot(3,1,1)
% plot(time_VO(1:Nins),SINS_position_error(1,:),'g','lineWidth',lineWidth);
...
% set(gcf,'position',figurePosition) ;
% subplot(3,1,1)
% plot(time_VO(1:Nins),SINS_position_error(2,:),'g','lineWidth',lineWidth);
% ylabel('惯导','fontsize',labelFontSize)
% subplot(3,1,2)
...
% set(gcf,'position',figurePosition) ;
% subplot(3,1,1)
% plot(time_VO(1:Nins),SINS_position_error(3,:),'g','lineWidth',lineWidth);
% ylabel('惯导','fontsize',labelFontSize)
% subplot(3,1,2)
...
hold on
plot(time_VO,newdQTb_attitude_error(1,:)*180/pi,'r','lineWidth',lineWidth);
legend('传统组合','新组合')
xlabel('时间（s）','fontsize',labelFontSize)
ylabel('俯仰误差(°)','fontsize',labelFontSize)

saveas(gcf,[path,'\俯仰误差.emf'])
saveas(gcf,[path,'\俯仰误差.fig'])
%% 横滚误差
figure('name','横滚误差')
set(gcf,'position',figurePosition) ;
subplot(2,1,1)
...
hold on
plot(time_VO,newdQTb_attitude_error(2,:)*180/pi,'r','lineWidth',lineWidth);
legend('传统组合','新组合')
xlabel('时间（s）','fontsize',labelFontSize)
ylabel('横滚误差(°)','fontsize',labelFontSize)

saveas(gcf,[path,'\横滚误差.emf'])
saveas(gcf,[path,'\横滚误差.fig'])
%% 航向误差
figure('name','航向误差')
set(gcf,'position',figurePosition) ;
subplot(2,1,1)
...
hold on
plot(time_VO,newdQTb_attitude_error(3,:)*180/pi,'r','lineWidth',lineWidth);
legend('传统组合','新组合')
xlabel('时间（s）','fontsize',labelFontSize)
ylabel('航向误差(°)','fontsize',labelFontSize)

saveas(gcf,[path,'\航向误差.emf'])
saveas(gcf,[path,'\航向误差.fig'])
% %% 俯仰误差
% figure('name','俯仰误差')
% set(gcf,'position',figurePosition) ;
% subplot(3,1,1)
...
% ylabel('视觉','fontsize',labelFontSize)
% subplot(3,1,3)
% plot(time_VO,dQTb_attitude_error(1,:)*180/pi,'g','lineWidth',lineWidth);
% hold on
% plot(time_VO,newdQTb_attitude_error(1,:)*180/pi,'r','lineWidth',lineWidth);
% 
% ylabel('组合','fontsize',labelFontSize)
