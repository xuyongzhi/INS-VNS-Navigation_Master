...
img_dir    = 'E:\¹ßÐÔÊÓ¾õµ¼º½\NAVIGATION\data_old\kitti\raw data\2011_09_30_drive_0028\2011_09_30_drive_0028_sync' ;
param.f     = 645.2;
param.cu    = 635.9;
param.cv    = 194.1;
param.base  = 0.571;
...
%   I2 = imread([img_dir '/I2_' num2str(frame,'%06d') '.png']);
  ...
  I1 = imread([img_dir '\image_00\data\' num2str(frame,'%010d') '.png']);
  I2 = imread([img_dir '\image_01\data\' num2str(frame,'%010d') '.png']);
  ...
  match = visualOdometryStereoMex('get_matches');
