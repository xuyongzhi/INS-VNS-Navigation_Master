...
function INS_VNS_NavResult = saveINS_VNS_NavResult(integFre,combineFre,imu_fre,projectName,gp,isKnowTrue,trueTraeFre,...
...
for j=1:resultNum
    ...
    INS_VNS_NavResult{j}.subName = {'x','y','z'};
end
...
if isKnowTrue==1
    ...
    text_error_xyz = GetErrorText( true_attitude_valid,INTGAttitudeError ) ;
    ...
    INS_VNS_NavResult{frontNum+10}.data = accDriftP/(gp*1e-6) ;     % 转换为 ug
