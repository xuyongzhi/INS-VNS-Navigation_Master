...
function INS_VNS_NavResult = saveResult_SINSerror_subQbbsubTbb(integFre,combineFre,imu_fre,projectName,gp,isKnowTrue,trueTraeFre,...
...
if ~isempty(Zinteg_error)
    ...
    INS_VNS_NavResult{resultN}.name = 'subQbb_error';
    INS_VNS_NavResult{resultN}.comment = 'subQbb一步预测偏差';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
...
if ~isempty(Zinteg_pre)
    ...
    INS_VNS_NavResult{resultN}.name = 'subQbb_pre';
...
if ~isempty(Zinteg)
    ...
    INS_VNS_NavResult{resultN}.name = 'subQbb';
