...
function INS_VNS_NavResult = saveResult_SINSerror_dMove_new(integFre,combineFre,imu_fre,projectName,gp,isKnowTrue,trueTraeFre,...
...
resultN = resultN+1;
INS_VNS_NavResult{resultN}.data = vnsRbbDrift*180/pi ;     % rad转化为 °
INS_VNS_NavResult{resultN}.name = 'vnsRbbDrift(°)';
INS_VNS_NavResult{resultN}.comment = '视觉旋转漂移估计';
INS_VNS_NavResult{resultN}.subName = {'x(°)','y(°)','z(°)'};

resultN = resultN+1;
INS_VNS_NavResult{resultN}.data = vnstbbDrift ;     
INS_VNS_NavResult{resultN}.name = 'vnstbbDrift(m)';
INS_VNS_NavResult{resultN}.comment = '视觉平移漂移估计';
INS_VNS_NavResult{resultN}.subName = {'bx(m)','by(m)','bz(m)'};
...
if ~isempty(Zinteg_error)
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = Zinteg_error(1:3,:) ;    
    INS_VNS_NavResult{resultN}.name = 'dQbb_error';
    INS_VNS_NavResult{resultN}.comment = 'dQbb一步预测偏差';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
    INS_VNS_NavResult{resultN}.subName = {'dq1_err','dq2_err','dq3_err'};
    
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = Zinteg_error(4:6,:) ;    
    INS_VNS_NavResult{resultN}.name = 'Tbb_error';
    INS_VNS_NavResult{resultN}.comment = 'Tbb一步预测偏差';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
end

if ~isempty(Zinteg_pre)
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = Zinteg_pre(1:3,:) ;    
    INS_VNS_NavResult{resultN}.name = 'dQbb_pre';
    INS_VNS_NavResult{resultN}.comment = 'dQbb一步预测';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
    INS_VNS_NavResult{resultN}.subName = {'dq1','dq2','dq3'};
    
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = Zinteg_pre(4:6,:) ;    
...
if ~isempty(Zinteg)
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = Zinteg(1:3,:) ;    
    INS_VNS_NavResult{resultN}.name = 'dQbb';
    INS_VNS_NavResult{resultN}.comment = '量测量dQbb';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
    INS_VNS_NavResult{resultN}.subName = {'dq1','dq2','dq3'};
    
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = Zinteg(4:6,:) ;    
    INS_VNS_NavResult{resultN}.name = 'dTbb';
    INS_VNS_NavResult{resultN}.comment = '量测量dTbb';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
end
...
if isKnowTrue==1
    ...
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = vnsRbbDriftP*180/pi ;     % 转换为 °
    INS_VNS_NavResult{resultN}.name = 'vnsRbbDriftP(°)';
    INS_VNS_NavResult{resultN}.comment = '视觉Rbb误差估计均方差';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
    INS_VNS_NavResult{resultN}.subName = {'x(°)','y(°)','z(°)'};
    
    resultN = resultN+1;
    INS_VNS_NavResult{resultN}.data = vnsTbbDriftP  ;     
    INS_VNS_NavResult{resultN}.name = 'vnsTbbDriftP(m)';
    INS_VNS_NavResult{resultN}.comment = '视觉Tbb误差估计均方差';
    INS_VNS_NavResult{resultN}.frequency = integFre ;
    INS_VNS_NavResult{resultN}.subName = {'x(m)','y(m)','z(m)'};
