...
% 2.dTbb 的 R阵 
function [ P_ini,Q_const,R_ini,NavFilterParameter ] = GetFilterParameter_dQTb_IVC( pg,ng,pa,na,NavFilterParameter )
%% 
...
R_list = [R_list_input,{'[[1 1 1]*1e4  [1 1 1]*1e-7] [1 1 1]*1e-18'...
                        '[[1 1 1]*1e1  [1 1 1]*1e-12] [1 1 1]*1e-18'...  % kitti 平面位置终点精度高
                        }];     
